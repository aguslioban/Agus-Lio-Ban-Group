    ...
    <footer className={`footer-footer ${props.rootClassName} `}>
      <div className="footer-container">
        <div className="footer-container1">
          ...
          <span className="">Copyright © 2022 AGUSLIOBANGROUP</span>
          <div className="footer-social-bar">
            ...
            <a
              href="https://www.tiktok.com/@agusliobangroup?is_from_webapp=1&amp;sender_device=pc"
              target="_blank"
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="footer-icon04">
              <path
        ...
        <div className="footer-container3">
          <div className="footer-container4">
            <span className="footer-text1 Large">Pages</span>
            <Link to="/service" className="footer-navlink1 Large">
              Service
            </Link>
            <Link to="/kemitraan" className="footer-navlink2 Large">
              Kemitraan
            </Link>
            <Link to="/contact" className="footer-text2">
              Contact
            </Link>
          </div>
          <div className="footer-container5">
            <span className="footer-text3 Large">Pages</span>
            <Link to="/spooring" className="footer-navlink3 Large">
              Spooring
            </Link>
            <Link to="/ac-lax" className="footer-navlink4 Large">
              Ac Lax
            </Link>
            <Link to="/tune-up" className="footer-navlink5 Large">
              Tune Up
            </Link>
          </div>
          <div className="footer-container6">
            <span className="footer-text4 Large">Products</span>
            <Link to="/ban" className="footer-navlink6 Large">
              Bridgestone
            </Link>
            <Link to="/ban" className="footer-navlink7 Large">
              Dunlop
            </Link>
            <Link to="/ban" className="footer-navlink8">
              Sailun
            </Link>
          </div>
        </div>
...
Footer.defaultProps = {
  image_alt1: 'image',
  image_src1:
    '/png-transparent-tiktok-tiktok-logo-tiktok-icon-removebg-preview-1500w.png',
  image_src: '/alb%20white-200h.png',
  image_alt: 'image',
  rootClassName: '',
}
